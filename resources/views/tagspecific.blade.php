         ...
         {{$shit =  $posts[0]->image_id}}
            ...
            <div class="row" style="padding-left: 10%;">
                ...
                @if($shit)
                    ...
                    <img style="max-width:40%;" src='{{ asset("img/uploaded/$shit") }}' >
                @endif
          ...
          <?php $some = explode(" ", $posts[$i]->created_at);
           ...
           $month = explode("-", $some[0])[1];
            if(strlen($posts[$i]->content) > 300){
              $posts[$i]->content = substr($posts[0]->content, 0, 300);
              $posts[$i]->content .= ".......";
             }
           ?>
</p>
             <div class="row" style="padding-left: 10%;">
                ...
                <div class="col-sm-7">
                    <div class="row">
                    @if($shit)
                        <img style="max-width: 250px;" src='{{ asset("img/uploaded/$shit") }}' onerror="this.style.display='none'">
                    @endif
